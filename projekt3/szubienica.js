var haslo ="trzej muszkieterowie";
...
function sprawdz(nr)
{
	...
	else
	{
		no.play();
		var element = "lit" + nr;
		document.getElementById(element).style.background = "#990033";
	...
	if(haslo == haslo1)
	{
		document.getElementById("alfabet").innerHTML = "Wygrałeś :) Podano prawidlowe hasło"+haslo+
	...
	if(skuchy>=9)
	{
		document.getElementById("alfabet").innerHTML = "Przegrałeś! Prawidlowe hasło "+haslo+
		'<br/><br/><span class="reset" onclick="location.reload()">JESZCZE RAZ?</span>';
	}
